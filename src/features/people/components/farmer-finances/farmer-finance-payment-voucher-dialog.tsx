...
function FarmerFinancePaymentVoucherDialogContent({
  ...
  const selectableLabel =
    mode === "receive" ? "Debit ledger" : "Credit ledger"
      ...
      >
        ...
        >
          <FieldGroup className="gap-4">
            ...
            {mode === "receive" ? (
              <form.Field name="paymentLedger">
                {(field) => {
                  ...
                  return (
                    <Field data-invalid={isInvalid}>
                      <FieldLabel htmlFor={selectableFieldId}>
                        {selectableLabel}
                      </FieldLabel>
                      <SearchableOptionCombobox
                        ...
                        setOpen={(open) =>
                          setPaymentCombobox((current) => ({ ...current, open }))
                        }
            ...
            <Field>
              <FieldLabel htmlFor={`${formId}-fixed-ledger`}>
                {fixedLabel}
              </FieldLabel>
              <Input
            ...
            <form.Field name="narration">
              {(field) => {
                ...
                return (
                  <Field data-invalid={isInvalid}>
                    <FieldLabel htmlFor={`${formId}-narration`}>
                      Narration
                    </FieldLabel>
                    <Textarea
                      id={`${formId}-narration`}
