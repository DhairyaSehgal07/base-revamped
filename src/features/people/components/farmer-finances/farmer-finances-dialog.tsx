...
export function FarmerFinancesDialog({
  ...
  const [activeAction, setActiveAction] = useState<FarmerFinanceAction | null>(
    null,
  )

  const subDialogProps = {
    onOpenChange: (nextOpen: boolean) =>
      handleSubDialogOpenChange(nextOpen, setActiveAction),
  }
  ...
  return (
    <>
      <Dialog
        ...
        onOpenChange={(nextOpen) =>
          handleHubOpenChange(nextOpen, onOpenChange, setActiveAction)
        }
      >
