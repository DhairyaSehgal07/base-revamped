...
function renderDialog(
  props: Partial<React.ComponentProps<typeof EditFarmerDialog>> = {},
) {
...
describe('EditFarmerDialog', () => {
  ...
  it('renders prefilled values from the farmer link', () => {
    ...
    expect(screen.getByPlaceholderText(/enter 10-digit mobile number/i)).toHaveValue(
      '9812345678',
    );
  ...
  it('allows keeping the same account number and mobile for the edited farmer', async () => {
    ...
    expect(
      screen.queryByText(/this account number is already in use/i),
