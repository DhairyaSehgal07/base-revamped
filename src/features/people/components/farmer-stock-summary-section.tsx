...
const QUANTITY_MODES = Object.keys(
  QUANTITY_MODE_LABELS,
) as StockQuantityMode[]
    ...
    >
      ...
      <div className="overflow-hidden rounded-xl border border-border bg-card text-card-foreground shadow-sm">
        <div className="space-y-0 bg-muted/20">
            ...
            <>
              <div className="px-3 pt-3 sm:px-4 sm:pt-4">
                <StockSummaryTabBar
                  ...
                  onValueChange={(value) =>
                    setStockFilterTab(value as StockFilterTab)
                  }
          ...
          <div className="px-3 py-2 sm:px-4 sm:py-3">
            <StockSummaryTabBar
              value={quantityMode}
              onValueChange={(value) =>
                setQuantityMode(value as StockQuantityMode)
              }
        ...
        <div className="border-t border-border p-3 sm:p-4">
          {isError ? (
            <Empty className="rounded-lg border bg-muted/10">
              <EmptyHeader>
