    ...
    <div className="flex w-full flex-col gap-4">
      ...
      <div className="flex flex-col gap-3 rounded-xl border bg-card p-3 text-card-foreground shadow-sm sm:gap-4 sm:p-4">
        <div className="relative w-full">
          ...
          <Input placeholder="Search dispatch ledger" className="w-full pl-10" />
        </div>
      ...
      <Empty className="rounded-xl border bg-muted/10">
        <EmptyHeader>
          ...
          <EmptyTitle>Dispatch ledger list coming soon</EmptyTitle>

          <EmptyDescription>
            Dispatch ledger records will appear here once this tab is connected
            to the API.
          </EmptyDescription>
        </EmptyHeader>
      </Empty>
