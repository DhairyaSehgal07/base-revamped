...
export function getStockSummaryAccent(
  quantityMode: StockQuantityMode,
): StockSummaryAccent {
  return quantityMode === "outgoing" ? "destructive" : "primary"
}

export function stockSummaryAccentTextClass(
  quantityMode: StockQuantityMode,
): string {
...
export function stockSummaryAccentBgClass(
  quantityMode: StockQuantityMode,
): string {
  return getStockSummaryAccent(quantityMode) === "destructive"
    ? "bg-destructive/5"
...
export function stockSummaryAccentHoverClass(
  quantityMode: StockQuantityMode,
): string {
  return getStockSummaryAccent(quantityMode) === "destructive"
...
export function getColumnAlign(
  meta: ColumnMeta | undefined,
): "left" | "right" {
  return meta?.align ?? "left"
}

export function getHeadClassName(
  meta: ColumnMeta | undefined,
