...
function FarmerGatePassDateFilters({
  from,
  to,
  onApply,
  onReset,
}: FarmerGatePassDateFiltersProps) {
    ...
    <div className="overflow-hidden rounded-xl border border-border bg-card shadow-sm">
      <div className="p-3 sm:p-4">
        <div className="flex flex-col gap-2 sm:flex-row">
          ...
          <div className="h-9 min-w-0 flex-1 rounded-md bg-muted" />
        </div>
      </div>
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:justify-between">
          <div className="flex min-w-0 flex-1 flex-col gap-2 sm:flex-row sm:flex-wrap">
            <div className="grid grid-cols-2 gap-2 sm:flex">
              <div className="h-9 w-full rounded-md bg-muted sm:w-36" />
              <div className="h-9 w-full rounded-md bg-muted sm:w-36" />
            </div>
            <div className="flex gap-2">
              <div className="h-9 flex-1 rounded-md bg-muted sm:w-24 sm:flex-none" />
              <div className="h-9 flex-1 rounded-md bg-muted sm:w-20 sm:flex-none" />
            </div>
          </div>
