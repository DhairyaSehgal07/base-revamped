...
export type TransferStockReportColumnId =
  | keyof TransferStockReportRecord
  | "fromName"
  | "fromAccountNumber"
  | "fromAddress"
  | "fromMobile"
...
export type AdvancedFilterCondition = {
  id: string
  columnId: TransferStockReportColumnId
...
const ADVANCED_NUMERIC_COLUMN_IDS = new Set<TransferStockReportColumnId>([
  "fromAccountNumber",
  "toAccountNumber",
  "gatePassNo",
  "totalBags",
...
export function isAdvancedNumericColumn(
  columnId: string,
): columnId is TransferStockReportColumnId {
  return (
    ADVANCED_NUMERIC_COLUMN_IDS.has(columnId as TransferStockReportColumnId) ||
