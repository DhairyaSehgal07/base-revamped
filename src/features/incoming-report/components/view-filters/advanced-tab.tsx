...
function getColumnLabel(column: Column<IncomingGatePassReportRecord, unknown>) {
  return column.columnDef.meta?.filterLabel ?? column.id
}

function getDefaultOperator(column: Column<IncomingGatePassReportRecord, unknown>) {
  return isAdvancedNumericColumn(column.id) ? "greaterThan" : "contains"
}

function getOperatorOptions(
  column: Column<IncomingGatePassReportRecord, unknown> | undefined,
) {
...
function createCondition(
  ...
  return {
    ...
    columnId: column.id as IncomingReportColumnId,
