...
export interface ReportToolbarProps {
  table: Table<IncomingGatePassReportRecord> | null
  dateFrom: string
  dateTo: string
    ...
    >
      ...
      >
        ...
        <div className="relative min-w-0 lg:min-w-44 lg:flex-1">
          ...
          <Input
            type="search"
            placeholder="Search incoming report..."
            value={searchQuery}
            onChange={(event) => onSearchChange(event.target.value)}
            disabled={isLoading}
            className="w-full pl-9"
            aria-label="Search incoming report"
          />
        </div>
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <Button
            ...
            aria-label="Preview incoming report"
            onClick={onPreview}
          ...
          <Button
            type="button"
            className="min-w-0 gap-1.5 lg:flex-none"
            aria-label="Export incoming report to Excel"
          ...
          <Button
            ...
            size="icon"
            className="shrink-0"
            aria-label="Refresh incoming report"
            disabled={isRefreshing}
            onClick={onRefresh}
          >
            <RefreshCw
