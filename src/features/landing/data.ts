...
export const ENTERPRISE_PARTNERS = [
  { name: 'Bhatti Agri Tech', logo: 'https://res.cloudinary.com/dakh64xhy/image/upload/v1759410800/Bhatti-Agritech_gwqywg.jpg' },
  { name: 'Kapur Farms', logo: 'https://res.cloudinary.com/dakh64xhy/image/upload/v1783787856/Screenshot_2026-07-11_at_10.07.28_PM_dfofqs.png' },
] as const;

export const BASE_OPERATORS = [
  { name: 'Raghav Cold Storage', logo: '' },
  { name: 'Satnam Cold Storage', logo: '' },
  { name: 'Bolina Farms', logo: 'https://res.cloudinary.com/dakh64xhy/image/upload/v1771577081/WhatsApp_Image_2026-02-20_at_14.13.32_phrbc8.jpg' },
  { name: 'Dihati Cold Storage', logo: '' },
  { name: 'Shri Guru Harigobind Cold Storage', logo: '' },
  { name: 'Mandeep Farms', logo: 'https://res.cloudinary.com/dakh64xhy/image/upload/v1771318114/WhatsApp_Image_2026-02-17_at_14.17.00_anwnpv.jpg' },
