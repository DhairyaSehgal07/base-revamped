        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground max-w-60 text-xs leading-relaxed">
              Made in India for cold storage operators. From gate pass to chamber stock — one system that keeps the
              floor running without paper.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <span className="border-primary/20 bg-primary/10 text-primary inline-flex items-center gap-1.5 rounded-md border px-2 py-1 text-[10px] font-semibold">
              <span className="bg-primary size-1.5 animate-pulse rounded-full" /> System: Active &amp; Online
            </span>
          </div>
        </div>
