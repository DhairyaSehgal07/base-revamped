...
export function Hero() {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(passCardRef.current, { y: 10, opacity: 0 }, { y: 0, opacity: 1, duration: 0.45, ease: 'power2.out' });
  }, [passIndex]);
  ...
  return (
    <section id="home" className="relative overflow-hidden scroll-mt-24">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div
          className="absolute inset-0 opacity-60 [mask-image:radial-gradient(ellipse_60%_60%_at_50%_35%,black,transparent)]"
          style={{
      ...
      <div className="mx-auto flex min-h-[calc(100svh-4rem)] max-w-7xl items-center px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="grid w-full grid-cols-1 items-center gap-14 lg:grid-cols-12">
          ...
          <div className="flex flex-col items-center justify-center gap-6 text-center lg:col-span-6 lg:items-start lg:self-center lg:text-left">
            ...
            <p data-anim="hero-item" className="text-muted-foreground max-w-lg text-base text-pretty sm:text-lg">
              Replace manual reporting with Coldop — real-time analytics, instant PDF and Excel exports, live stock ledgers, and precise location tracking by chamber, floor, and row.
            </p>

            <div data-anim="hero-item" className="flex flex-wrap items-center justify-center gap-3 lg:justify-start">
              {accountCta}
          ...
          <div className="flex justify-center lg:col-span-6 lg:self-center">
            <div data-anim="hero-visual" className="relative w-full max-w-[540px]">
              <div aria-hidden className="bg-primary/10 absolute -inset-8 -z-10 rounded-full blur-3xl" />
                ...
                <div className="space-y-3 p-5">
                  ...
                  <div ref={passCardRef}>
                    <Card className="card-hover overflow-hidden border border-border/60">
                      <CardHeader className="flex flex-col gap-3 border-b border-border/40 bg-muted/10 pb-3 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <Card size="sm" className="gap-0 border border-border/60 shadow-none ring-0">
