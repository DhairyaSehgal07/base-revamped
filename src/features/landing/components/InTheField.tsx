        ...
        <div data-reveal-group className="mt-14 grid grid-cols-1 items-start gap-8 md:grid-cols-12">
          <div className="space-y-4 md:col-span-8">
            ...
            <div className="space-y-1 px-2">
              <h3 className="text-lg font-semibold">From Registers to Real-Time: The ColdOp Story</h3>
              <p className="text-muted-foreground text-sm text-pretty">
                How traditional cold storages ran operations before and after adopting the Coldop platform.
              </p>
            </div>
          </div>
