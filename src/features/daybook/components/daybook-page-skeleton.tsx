    ...
    <div className="flex w-full flex-col gap-4">
      ...
      <div className="flex flex-col gap-3 rounded-xl border bg-card p-3 text-card-foreground shadow-sm sm:gap-4 sm:p-4">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
          <Skeleton className="order-1 h-11 w-full rounded-md sm:order-2 sm:flex-1" />
          <Skeleton className="order-2 h-10 w-full rounded-md sm:order-1 sm:w-[150px] sm:shrink-0" />
        </div>
