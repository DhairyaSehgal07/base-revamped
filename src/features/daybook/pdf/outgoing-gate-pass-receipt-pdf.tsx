      ...
      <View>
        ...
        <View style={styles.panel}>
          ...
          {hasTruckNo ? (
            <View
              style={[
                styles.voucherRow,
                ...(varietyIsLast ? [styles.noBorderBottom] : []),
              ]}
            >
              <View style={[styles.vLabel, styles.w15]}>
          ...
          {showRoute && hasFrom && hasTo ? (
            <View
              style={[
                styles.voucherRow,
                ...(routeIsLast ? [styles.noBorderBottom] : []),
              ]}
            >
              <View style={[styles.vLabel, styles.w15]}>
        ...
        <View style={styles.panel}>
          <View style={styles.tableHeaderRow}>
            ...
            <Text style={[styles.colVariety, styles.colTextHeader]}>
              Variety
            </Text>
            <Text style={[styles.colLocation, styles.colTextHeader]}>
              Location
            </Text>
          ...
          {orderRows.map((row, index) => (
            ...
            >
              <Text style={[styles.colSize, styles.colTextData]}>
                {row.bagSize}
              </Text>
              <Text style={[styles.colVariety, styles.colTextData]}>
                {row.variety}
              </Text>
              <Text style={[styles.colLocation, styles.colTextMuted]}>
                {row.location}
              </Text>
...
export default function OutgoingGatePassReceiptPdf(
  props: OutgoingGatePassReceiptPdfProps,
) {
  return (
    <Document
      author="Coldop"
