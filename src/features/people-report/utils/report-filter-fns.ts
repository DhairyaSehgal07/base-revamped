...
export type FarmerReportColumnId =
  | "date"
  | "gatePassNo"
  | "manualParchiNumber"
  | "variety"
...
const ADVANCED_NUMERIC_COLUMN_IDS = new Set<FarmerReportColumnId>([
  "gatePassNo",
  "rowBags",
  "totalBags",
])
...
export function isAdvancedNumericColumn(
  columnId: string,
): columnId is FarmerReportColumnId {
  return (
    ADVANCED_NUMERIC_COLUMN_IDS.has(columnId as FarmerReportColumnId) ||
