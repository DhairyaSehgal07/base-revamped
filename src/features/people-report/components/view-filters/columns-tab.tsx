...
import {
  clearStoredFarmerReportColumnState,
  hasStoredFarmerReportColumnState,
  saveFarmerReportColumnState,
} from "@/features/people-report/utils/report-column-preferences"
import { cn } from "@/lib/utils"

const COLUMN_ORDER_GROUP = "farmer-stock-ledger-columns"
...
const ColumnsTab = <TData extends RowData>({
  ...
  const handleSaveDefaultColumns = () => {
    const saved = saveFarmerReportColumnState(
      columnIds,
      draftColumnVisibility,
      draftColumnOrder,
    )
  ...
  const handleClearDefaultColumns = () => {
    const cleared = clearStoredFarmerReportColumnState()
