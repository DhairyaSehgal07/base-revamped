          ...
          <FieldGroup className="gap-6">
            ...
            <form.Field name="debitLedger">
              {(field) => {
                ...
                return (
                  <Field data-invalid={isInvalid}>
                    <FieldLabel htmlFor="edit-voucher-debit-ledger">
                      Debit ledger
                    </FieldLabel>
                    <SearchableOptionCombobox
                      ...
                      setOpen={(open) =>
                        setDebitCombobox((current) => ({ ...current, open }))
                      }
                    />
                    {isInvalid && (
                      <FieldError errors={field.state.meta.errors} />
            ...
            <form.Field name="creditLedger">
              {(field) => {
                ...
                return (
                  <Field data-invalid={isInvalid}>
                    <FieldLabel htmlFor="edit-voucher-credit-ledger">
                      Credit ledger
                    </FieldLabel>
                    <SearchableOptionCombobox
                      ...
                      setOpen={(open) =>
                        setCreditCombobox((current) => ({ ...current, open }))
                      }
                    />
                    {isInvalid && (
                      <FieldError errors={field.state.meta.errors} />
            ...
            <form.Field name="narration">
              {(field) => {
                ...
                return (
                  <Field data-invalid={isInvalid}>
                    <FieldLabel htmlFor="edit-voucher-narration">
                      Narration
                    </FieldLabel>
                    <Textarea
