          ...
          <FieldGroup className="gap-4">
                ...
                return (
                  <form.Field name="subType">
                    {(field) => {
                      ...
                      return (
                        <Field data-invalid={isInvalid}>
                          <FieldLabel htmlFor="edit-ledger-sub-type">
                            Sub type
                          </FieldLabel>
                          <SearchableOptionCombobox
                ...
                return (
                  <form.Field name="category">
                    {(field) => {
                      ...
                      return (
                        <Field data-invalid={isInvalid}>
                          <FieldLabel htmlFor="edit-ledger-category">
                            Category
                          </FieldLabel>
                          <SearchableOptionCombobox
            ...
            <form.Field name="openingBalance">
              {(field) => {
                ...
                return (
                  <Field data-invalid={isInvalid}>
                    <FieldLabel htmlFor="edit-ledger-opening-balance">
                      Opening balance
                    </FieldLabel>
                    <FieldDescription>
            ...
            <form.Field name="closingBalance">
              {(field) => {
                ...
                return (
                  <Field data-invalid={isInvalid}>
                    <FieldLabel htmlFor="edit-ledger-closing-balance">
                      Closing balance
                    </FieldLabel>
                    <FieldDescription>
                      Optional. Set directly for stock-style ledgers. Leave blank
                      for none.
                    </FieldDescription>
                    <Input
