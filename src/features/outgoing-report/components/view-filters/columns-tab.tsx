...
import {
  clearStoredOutgoingReportColumnState,
  hasStoredOutgoingReportColumnState,
  saveOutgoingReportColumnState,
} from "@/features/outgoing-report/utils/report-column-preferences"
import { cn } from "@/lib/utils"

const COLUMN_ORDER_GROUP = "outgoing-report-columns"
...
const ColumnsTab = <TData extends RowData>({
  ...
  const handleSaveDefaultColumns = () => {
    const saved = saveOutgoingReportColumnState(
      columnIds,
      draftColumnVisibility,
      draftColumnOrder,
    )
  ...
  const handleClearDefaultColumns = () => {
    const cleared = clearStoredOutgoingReportColumnState()
