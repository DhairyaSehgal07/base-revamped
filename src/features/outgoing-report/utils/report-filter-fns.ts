...
export type OutgoingReportColumnId =
  | keyof OutgoingGatePassReportRecord
  | "name"
  | "address"
  | "accountNumber"
  | "createdBy"
...
export type AdvancedFilterCondition = {
  id: string
  columnId: OutgoingReportColumnId
...
const ADVANCED_NUMERIC_COLUMN_IDS = new Set<OutgoingReportColumnId>([
  "accountNumber",
  "gatePassNo",
  "manualParchiNumber",
  "totalBags",
...
export function isAdvancedNumericColumn(
  columnId: string,
): columnId is OutgoingReportColumnId {
  return (
    ADVANCED_NUMERIC_COLUMN_IDS.has(columnId as OutgoingReportColumnId) ||
