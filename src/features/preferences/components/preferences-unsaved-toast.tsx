...
function showUnsavedToast(
  ...
  toast.custom(
    () => (
      <div className="flex w-[min(100vw-2rem,22rem)] flex-col gap-3 rounded-lg border border-border bg-popover p-4 text-popover-foreground shadow-lg">
...
export function PreferencesUnsavedToast({
  form,
  isPending,
}: PreferencesUnsavedToastProps) {
  return (
    <form.Subscribe
      selector={(state) => ({
