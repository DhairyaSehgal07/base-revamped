...
export function PreferencesCustomFieldsSection({
  form,
}: PreferencesCustomFieldsSectionProps) {
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Additional configuration for your cold storage.
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          {(field) => (
            <div className="flex flex-col gap-4">
              {field.state.value.map((_, index) => (
                <div
                  key={index}
                  className="grid gap-4 rounded-xl border border-border p-4 sm:grid-cols-[1fr_1fr_auto]"
                >
