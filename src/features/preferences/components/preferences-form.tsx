        ...
        <Card>
          ...
          <CardContent>
            <FieldGroup>
                  ...
                  return (
                    <Field data-invalid={isInvalid}>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          field.handleChange(
                            value as (typeof REPORT_FORMAT_OPTIONS)[number],
                          )
                        }
                      >
                        <SelectTrigger
                ...
                {(field) => (
                  <Field orientation="horizontal">
                    <FieldContent>
                      ...
                      <FieldDescription>
                        Enable stock filtering in inventory views
                      </FieldDescription>
                    </FieldContent>
                    <Switch
                      id={field.name}
              ...
              <form.Subscribe
                selector={(state) => state.values.stockFilter.enabled}
              >
                {(stockFilterEnabled) =>
                  stockFilterEnabled ? (
                    <form.Field name="stockFilter.options" mode="array">
                      {(listField) => {
                        const listInvalid =
                          listField.state.meta.isTouched &&
                          !listField.state.meta.isValid

                        return (
                          <Field data-invalid={listInvalid}>
                            <FieldLabel>Stock filter options</FieldLabel>
                            <FieldDescription>
                              Define the filter values available in inventory
                              views.
                            </FieldDescription>
                            ...
                            <div className="flex flex-col gap-2">
                                      ...
                                      return (
                                        <div className="flex items-start gap-2">
                                          ...
                                          <Button
                                            ...
                                            onClick={() =>
                                              listField.removeValue(itemIndex)
                                            }
                                          >
                                            <Trash2
                                              className="size-4"
                              ...
                              {listInvalid &&
                                listField.state.meta.errors.length > 0 && (
                                  <FieldError
                                    errors={listField.state.meta.errors}
                                  />
                                )}
                            </div>
