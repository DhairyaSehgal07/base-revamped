...
export function PreferencesCommoditiesSection({
  form,
}: PreferencesCommoditiesSectionProps) {
  return (
    <Card>
      <CardHeader>
              ...
              {field.state.value.length === 0 ? (
                <Empty className="border border-dashed border-border p-8">
                  <EmptyHeader>
                    ...
                    <EmptyDescription>
                      Add commodities to define varieties and sizes for your cold
                      storage.
                    </EmptyDescription>
                  </EmptyHeader>
                </Empty>
                  ...
                  >
                    ...
                    <div className="grid gap-6 lg:grid-cols-2">
                      <CommodityStringListField
                        ...
                        itemLabel={(itemIndex) =>
                          `Variety ${itemIndex} for commodity ${index + 1}`
                        }
                      />
                      <CommodityStringListField
                        form={form}
                        ...
                        addLabel="Add size"
                        itemLabel={(itemIndex) =>
                          `Size ${itemIndex} for commodity ${index + 1}`
                        }
                      />
                    </div>
                  </div>
